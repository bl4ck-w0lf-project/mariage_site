import { Sparkles, Camera, Flower2, Music, UtensilsCrossed, MapPin, ArrowRight, MessageCircle, Calendar, Heart, ChevronRight } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
          {services.map((service) => (
            <div
              key={service.title}
              className={`group relative p-8 rounded-2xl border transition-all duration-500 hover:-translate-y-2 cursor-pointer ${
                service.isFeatured 
            ...
            >
              {/* Numéro en Syne */}
              <div className={`absolute top-6 right-6 text-4xl font-syne font-bold tracking-tighter transition-all duration-300 ${
                service.isFeatured
              ...
              {/* Icône */}
              <div className={`w-14 h-14 rounded-xl flex items-center justify-center mb-5 transition-all duration-300 group-hover:scale-110 group-hover:shadow-lg ${
                service.isFeatured
              ...
              {/* Titre en Outfit */}
              <h3 className={`text-lg font-outfit font-semibold mb-2 transition-colors duration-300 ${
                service.isFeatured
                  ? 'text-rose-700'
