...
const Gallery = () => {
  ...
  const columnImages = [
    ...
    [
      { id: 1, category: 'Cérémonie', label: 'Échange de voeux', src: '/src/assets/gallery/1.jpeg' },
      { id: 2, category: 'Décoration', label: 'Table d\'honneur', src: '/src/assets/gallery/1.jpeg' },
      { id: 3, category: 'Couple', label: 'Séance photo', src: '/src/assets/gallery/1.jpeg' },
      { id: 4, category: 'Fleurs', label: 'Bouquet de mariée', src: '/src/assets/gallery/1.jpeg' },
      { id: 5, category: 'Lieu', label: 'Salle de réception', src: '/src/assets/gallery/1.jpeg' },
      { id: 6, category: 'Gastronomie', label: 'Dîner de gala', src: '/src/assets/gallery/1.jpeg' },
    ...
    [
      ...
      { id: 4, category: 'Fleurs', label: 'Bouquet de mariée', src: '/src/assets/gallery/1.jpeg' },
      { id: 3, category: 'Couple', label: 'Séance photo', src: '/src/assets/gallery/1.jpeg' },
      { id: 2, category: 'Décoration', label: 'Table d\'honneur', src: '/src/assets/gallery/1.jpegg' },
      { id: 1, category: 'Cérémonie', label: 'Échange de voeux', src: '/src/assets/gallery/1.jpeg' },
    ],
